...
@section('content')
    <div class="home-section fullwidth-slider-fade bg-dark" id="home">
        ...
        <!-- Slide Item -->
        <section class="home-section bg-scroll bg-dark-alfa-50" data-background="img/bgImage25.JPG">
        ...
        <!-- Slide Item -->
        <section class="home-section bg-scroll bg-dark-alfa-30" data-background="img/decor2.jpg">
            <div class="js-height-full container">
        ...
        <!-- Slide Item -->
        <section class="home-section bg-scroll bg-dark-alfa-30" data-background="img/bgImage25.JPG">
            <div class="js-height-full container">
