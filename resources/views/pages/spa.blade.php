...
@section('content')
    <div class="home-section fullwidth-slider-fade bg-dark" id="home">
        ...
        <!-- Slide Item -->
        <section class="home-section bg-scroll bg-dark-alfa-50" data-background="img/spa.jpg">
        ...
        <!-- Slide Item -->
        <section class="home-section bg-scroll bg-dark-alfa-30" data-background="img/spa1.jpg">
            <div class="js-height-full container">
        ...
        <!-- Slide Item -->
        <section class="home-section bg-scroll bg-dark-alfa-30" data-background="img/spa2.jpg">
            <div class="js-height-full container">
